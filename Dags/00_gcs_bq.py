...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='hien-elt-project.staging_datasets.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV',
