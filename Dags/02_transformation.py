...
project_id = 'hien-elt-project'
dataset_id = 'staging_datasets'  # Only include the dataset name here, not the project ID
transform_dataset_id = 'transform_dataset'

source_table = f'{project_id}.{dataset_id}.global_data'  # Correctly format the BigQuery table reference
countries = ['USA', 'India', 'Germany', 'Japan', 'France', 'Canada', 'Italy']  # Country-specific tables to be created

# DAG definition
with DAG(
    dag_id='02_load_and_transform',
